 ...
 * @author Alumno
 */
public class AcsNom extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                set.executeUpdate(q);
                out.println("<div class='container'><h1>Alumno Editado</h1></div>");
                ...
                System.out.println(e.getMessage());
                System.out.println(e.getStackTrace());
                out.println("<div class='container'><h1>Error, no se ha podido editar</h1></div>");
